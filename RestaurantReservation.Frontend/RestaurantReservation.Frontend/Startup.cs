...
namespace RestaurantReservation.Frontend
{
    ...
    {
        httpClient.BaseAddress = new Uri("http://localhost:5000/"); // Set the correct backend port
        httpClient.DefaultRequestHeaders.Add("Accept", "application/json"); // Set the desired content type header
    });
            #endregion
...
//code for specific baseaddress
//services.AddHttpClient("api", (serviceProvider, client) =>
//{
//    client.BaseAddress = new Uri(Configuration["APIServer:BaseAddress"]);
//    client.DefaultRequestHeaders.Add("Accept", SD.CONTENT_JSON);
//});
//where is the 5000 port come from?
//app.UseEndpoints(endpoints =>
//{
//    endpoints.MapRazorPages();
...
//});
//where is the backendport in frontend come from?
//services.AddHttpClient("api", (serviceProvider, client) =>
//{
//    client.BaseAddress = new Uri(Configuration["APIServer:BaseAddress"]);
//    client.DefaultRequestHeaders.Add("Accept", SD.CONTENT_JSON);
